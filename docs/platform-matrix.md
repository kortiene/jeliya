...
| macOS | system WebView (WebKit) | no separate floor recorded yet; nested native and WebView artifacts are signed before the outer app and DMG | planned, unverified, unreleased (#186) |
