...
| Current source candidate | `9c71fac2104a74076662177cf4ef74bb5050bae9` with Iroh Rooms `a5d98b70d717f35d3ce60953a88e12e646f2e871` |
...
| Direct cross-network P2P | implemented | certified for `v0.5.0` and the prior `v0.6.0` snapshot; current candidate pending | released in `v0.5.0` | [Signed schema 2 direct run `1ca39cfa`](evidence/v0.6.0/direct.json) certifies `55024a4…` + `71fbb500…`; it does not transfer to `9c71fac…` + `a5d98b70…`. |
